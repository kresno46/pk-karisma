        ...
        <div class="container max-w-[1130px] mx-auto flex flex-col gap-[50px] items-center">
            <div class="flex flex-col gap-[50px] items-center">
                <div class="breadcrumb flex items-center justify-center gap-[30px]">
                    ...
                    <p class="text-cp-light-grey last-of-type:text-cp-black last-of-type:font-semibold">Perusahaan</p>
                </div>
                <h2 class="font-bold text-4xl leading-[45px] text-center">
                    Tim Kami <br />
                    Siap Mendukung Kebutuhan Kayu Anda
                </h2>
            </div>
    ...
    <div id="Values" class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-20">
        <div class="flex items-center justify-between">
            <div class="flex flex-col gap-[14px]">
                ...
                <h2 class="font-bold text-4xl leading-[45px]">Budaya Kerja &<br />Komitmen</h2>
            </div>
            <a href="{{ route('front.about') }}" class="bg-cp-black p-[14px_20px] w-fit rounded-xl font-bold text-white">Tentang Kami</a>
        </div>
        <div class="awards-card-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px] justify-center">
            <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
                ...
                <p class="font-bold text-xl leading-[30px]">Kualitas</p>
                <hr class="border-[#E8EAF2]" />
                <p class="text-cp-light-grey">Standar mutu konsisten</p>
            </div>
            <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
                <div class="w-[55px] h-[55px] flex shrink-0">
                    <img src="{{ asset('assets/icons/cup-blue.svg') }}" alt="icon" />
                ...
                <hr class="border-[#E8EAF2]" />
                <p class="font-bold text-xl leading-[30px]">Ketepatan</p>
                <hr class="border-[#E8EAF2]" />
                <p class="text-cp-light-grey">Pengiriman tepat waktu</p>
            </div>
            <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
                <div class="w-[55px] h-[55px] flex shrink-0">
                    <img src="{{ asset('assets/icons/cup-blue.svg') }}" alt="icon" />
                ...
                <hr class="border-[#E8EAF2]" />
                <p class="font-bold text-xl leading-[30px]">Keamanan</p>
                <hr class="border-[#E8EAF2]" />
                <p class="text-cp-light-grey">Proses kerja aman</p>
            </div>
            <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
                <div class="w-[55px] h-[55px] flex shrink-0">
                    <img src="{{ asset('assets/icons/cup-blue.svg') }}" alt="icon" />
                ...
                <hr class="border-[#E8EAF2]" />
                <p class="font-bold text-xl leading-[30px]">Keberlanjutan</p>
                <hr class="border-[#E8EAF2]" />
                <p class="text-cp-light-grey">Bahan baku bertanggung jawab</p>
            </div>
        </div>
    </div>
@endsection
