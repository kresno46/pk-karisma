    ...
    <div id="Certifications" class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-20">
        <div class="flex items-center justify-between">
            <div class="flex flex-col gap-[14px]">
                ...
                <h2 class="font-bold text-4xl leading-[45px]">Komitmen Mutu &<br />Kepatuhan</h2>
            </div>
            <a href="{{ route('front.products') }}" class="bg-cp-black p-[14px_20px] w-fit rounded-xl font-bold text-white">Lihat Produk</a>
        </div>
        <div class="awards-card-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px] justify-center">
            <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
                ...
                <p class="font-bold text-xl leading-[30px]">SVLK (Legalitas Kayu)</p>
                <hr class="border-[#E8EAF2]" />
                <p class="text-cp-light-grey">Kepatuhan & legalitas</p>
            </div>
            <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
                <div class="w-[55px] h-[55px] flex shrink-0">
                    <img src="{{ asset('assets/icons/cup-blue.svg') }}" alt="icon" />
                ...
                <hr class="border-[#E8EAF2]" />
                <p class="font-bold text-xl leading-[30px]">FSC (Opsional)</p>
                <hr class="border-[#E8EAF2]" />
                <p class="text-cp-light-grey">Pengelolaan lestari</p>
            </div>
            <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
                <div class="w-[55px] h-[55px] flex shrink-0">
                    <img src="{{ asset('assets/icons/cup-blue.svg') }}" alt="icon" />
                ...
                <hr class="border-[#E8EAF2]" />
                <p class="font-bold text-xl leading-[30px]">ISO 9001 (Opsional)</p>
                <hr class="border-[#E8EAF2]" />
                <p class="text-cp-light-grey">Sistem manajemen mutu</p>
            </div>
            <div class="card bg-white flex flex-col h-full p-[30px] gap-[30px] rounded-[20px] border border-[#E8EAF2] hover:border-cp-dark-blue transition-all duration-300">
                <div class="w-[55px] h-[55px] flex shrink-0">
                    <img src="{{ asset('assets/icons/cup-blue.svg') }}" alt="icon" />
                ...
                <hr class="border-[#E8EAF2]" />
                <p class="font-bold text-xl leading-[30px]">ISO 14001 (Opsional)</p>
                <hr class="border-[#E8EAF2]" />
                <p class="text-cp-light-grey">Manajemen lingkungan</p>
            </div>
        </div>
    </div>
@endsection
