    ...
    <div id="Contact" class="container max-w-[1130px] mx-auto flex flex-wrap xl:flex-nowrap justify-between gap-[50px] relative z-10">
        <div class="flex flex-col mt-20 gap-[50px]">
            <div class="breadcrumb flex items-center gap-[30px]">
                ...
                <span class="text-cp-light-grey">/</span>
                <p class="text-cp-light-grey last-of-type:text-cp-black last-of-type:font-semibold">Minta Penawaran</p>
            </div>

            <h1 class="font-extrabold text-4xl leading-[45px]">Konsultasi & Penawaran Produk Kayu</h1>
            ...
            <div class="flex flex-col gap-5">
                ...
                @if(config('company.phone'))
                    <div class="flex items-center gap-[10px]">
                        ...
                        <p class="text-cp-dark-blue font-semibold">{{ config('company.phone') }}</p>
                    </div>
                @endif
                @if(config('company.website'))
                    <div class="flex items-center gap-[10px]">
                        ...
                        <p class="text-cp-dark-blue font-semibold">{{ config('company.website') }}</p>
                    </div>
                @endif
                @if(config('company.email'))
                    <div class="flex items-center gap-[10px]">
                        ...
                        <p class="text-cp-dark-blue font-semibold">{{ config('company.email') }}</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <form action="{{ route('front.appointment.store') }}" method="POST" class="flex flex-col p-[30px] rounded-[20px] gap-[18px] bg-white shadow-[0_10px_30px_0_#D1D4DF40] w-full md:w-[700px] shrink-0">
            ...
            <div class="flex items-center gap-[18px]">
                <div class="flex flex-col gap-2 flex w-full">
                    ...
                    <div class="flex items-center gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
                        ...
                        <input type="text" name="name" class="appearance-none outline-none bg-white placeholder:font-normal placeholder:text-cp-black font-semibold w-full" placeholder="Tulis nama lengkap" required />
                    </div>
                </div>
                <div class="flex flex-col gap-2 flex w-full">
                    ...
                    <div class="flex items-center gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
                        ...
                        <input type="email" name="email" class="appearance-none outline-none bg-white placeholder:font-normal placeholder:text-cp-black font-semibold w-full" placeholder="Tulis alamat email" required />
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-[18px]">
                <div class="flex flex-col gap-2 flex w-full">
                    <p class="font-semibold">No. Telepon/WhatsApp</p>
                    <div class="flex items-center gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
                        <div class="w-[18px] h-[18px] flex shrink-0">
                            <img src="{{ asset('assets/icons/call-black.svg') }}" alt="icon" />
                        </div>
                        <input type="tel" name="phone_number" class="appearance-none outline-none bg-white placeholder:font-normal placeholder:text-cp-black font-semibold w-full" placeholder="Tulis nomor telepon" required />
                    </div>
                </div>
                <div class="flex flex-col gap-2 flex w-full">
                    <p class="font-semibold">Tanggal Kontak</p>
            ...
            <div class="flex items-center gap-[18px]">
                <div class="flex flex-col gap-2 flex w-full">
                    <p class="font-semibold">Produk yang Dibutuhkan</p>
                    <div class="flex items-center gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
                        <div class="w-[18px] h-[18px] flex shrink-0">
                            <img src="{{ asset('assets/icons/building-4-black.svg') }}" alt="icon" />
                        </div>
                        <select name="product_id" class="appearance-none outline-none w-full invalid:font-normal font-semibold px-[10px] -mx-[10px]" required>
            ...
            <div class="flex flex-col gap-2 flex w-full">
                <p class="font-semibold">Kebutuhan / Catatan</p>
                <div class="flex gap-[10px] p-[14px_20px] border border-[#E8EAF2] focus-within:border-cp-dark-blue transition-all duration-300 rounded-xl bg-white">
                    ...
                    <textarea name="brief" rows="6" class="appearance-none outline-none bg-white placeholder:font-normal placeholder:text-cp-black font-semibold w-full resize-none" placeholder="Jelaskan kebutuhan ukuran/grade/jumlah, tujuan penggunaan, dan alamat pengiriman"></textarea>
                </div>
            </div>
